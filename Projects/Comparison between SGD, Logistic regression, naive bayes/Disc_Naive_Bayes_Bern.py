...
def train_model(data):
    ...
    count_of_docs_with_word_in_spam = spam_data.sum(axis=0) + 1
    ...
    list_of_p_word_spam = count_of_docs_with_word_in_spam/(len(spam_data) + 2)
    # log probability
    ...
    # Add one laplace smoothing is done using broadcasting
    count_of_docs_with_word_in_ham = ham_data.sum(axis=0) + 1
    # Total number of words in ham
    # count_of_all_words_in_ham = count_of_docs_with_word_in_ham.sum()
    # probability of each word given email is ham
    list_of_p_word_ham = count_of_docs_with_word_in_ham/(len(ham_data) + 2)
    # log probability
...
p_word_spam, p_word_ham, p_spam, p_ham = train_model(final_bern_representation)
print(p_word_spam)
print(p_word_ham)
